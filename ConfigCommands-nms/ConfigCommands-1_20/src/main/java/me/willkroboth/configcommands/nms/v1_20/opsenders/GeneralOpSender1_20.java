...
/**
 * An OpSender that works for any {@link CommandSender} on Minecraft 1.20 and 1.20.1.
 */
public class GeneralOpSender1_20 extends CraftBlockCommandSender implements OpSender1_20 {
    private final CommandSender sender;
    private final CommandSourceStack listener;
    private final CraftBlock fakeBlock;

    /**
     * Creates a new {@link GeneralOpSender1_20}.
     *
     * @param sender The {@link CommandSender} this {@link GeneralOpSender1_20} is wrapping.
     */
    public GeneralOpSender1_20(CommandSender sender) {
        super(null, null);
    ...
    private CommandSourceStack buildListener(CommandSender sender) {
        ...
        return OpSender1_20.modifyStack(stack, this);
    }
