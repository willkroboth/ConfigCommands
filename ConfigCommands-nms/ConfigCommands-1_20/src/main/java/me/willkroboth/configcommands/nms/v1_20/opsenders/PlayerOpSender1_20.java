...
/**
 * A {@link Player} OpSender for Minecraft 1.20 and 1.20.1.
 */
public class PlayerOpSender1_20 extends CraftPlayer implements OpSender1_20 {
    // listener created through return ((CraftPlayer)sender).getHandle().createCommandSourceStack();
    private final Player p;

    /**
     * Creates a new {@link PlayerOpSender1_20}.
     *
     * @param p The {@link CraftPlayer} this {@link PlayerOpSender1_20} is wrapping.
     */
    public PlayerOpSender1_20(CraftPlayer p) {
    ...
    private static class ServerPlayerOpWrapper extends ServerPlayer {
        private PlayerOpSender1_20 source = null;
        ...
        public void setSource(PlayerOpSender1_20 source) {
            if (this.source == null)
                this.source = source;
            else
