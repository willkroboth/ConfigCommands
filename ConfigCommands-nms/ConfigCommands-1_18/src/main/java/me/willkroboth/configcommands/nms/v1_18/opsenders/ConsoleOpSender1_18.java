...
/**
 * A {@link org.bukkit.command.ConsoleCommandSender} OpSender for Minecraft 1.18 and 1.18.1.
 */
public class ConsoleOpSender1_18 extends CraftConsoleCommandSender implements OpSender1_18 {
    private static ConsoleOpSender1_18 instance;

    public static void initializeInstance(ConsoleCommandSender source) {
        instance = new ConsoleOpSender1_18((CraftConsoleCommandSender) source);
    }

    public static ConsoleOpSender1_18 getInstance() {
        return instance;
    }
    ...
    /**
     * Creates a new {@link ConsoleOpSender1_18}.
     *
     * @param c The {@link CraftConsoleCommandSender} this {@link ConsoleOpSender1_18} is wrapping.
     */
