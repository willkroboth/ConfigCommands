...
public class HelpCommandHandler {
    private static final ArgumentTree argumentTree =
            ((LiteralArgument) helpBranch("help", HelpCommandHandler.getHelpMessages()))
    ...
    private static ArgumentTree helpBranch(String name, String... messages) {
        return new LiteralArgument(name).executes(sendMessages(messages));
    }
