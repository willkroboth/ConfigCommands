...
/**
 * A {@link org.bukkit.command.BlockCommandSender} OpSender for Minecraft 1.17 and 1.17.1.
 */
public class BlockOpSender1_17 extends CraftBlockCommandSender implements OpSender1_17 {
    ...
    /**
     * Creates a new {@link BlockOpSender1_17}.
     *
     * @param b The {@link CraftBlockCommandSender} this {@link BlockOpSender1_17} is wrapping.
     */
    public BlockOpSender1_17(CraftBlockCommandSender b) {
        super(b.getWrapper(), null);
        block = OpSender1_17.modifyStack(b.getWrapper(), this);
        tile = b.getBlock();
        sender = b;
    }
