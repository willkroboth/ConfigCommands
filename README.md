...
`[Variable]` refers to the name of a variable. Variables are described in more detail [below](https://github.com/willkroboth/ConfigCommands/edit/main/README.md#variables).

`[Expression]` can be any Expression, described in more detail [below](https://github.com/willkroboth/ConfigCommands/edit/main/README.md#expressions).
