...
//
//    // command functions
//    private static final Map<String, CommandTreeBuilder> commands = new HashMap<>();
...
//    public static void addCommand(CommandTreeBuilder commandTreeBuilder, String key) {
//        commands.put(commandTreeBuilder.getName(), commandTreeBuilder);
//        nameToKey.put(commandTreeBuilder.getName(), key);
//        keyToName.put(key, commandTreeBuilder.getName());
//    }
//
